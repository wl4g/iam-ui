...
<template>
  <el-row class="box-card">
    <el-radio-group v-model="radioValue" @change="onChange">
      <el-radio-button :label="$t('shardingsphere.ruleConfig.radioBtn.schema')" />
      <el-radio-button :label="$t('shardingsphere.ruleConfig.radioBtn.authentication')" />
      <el-radio-button :label="$t('shardingsphere.ruleConfig.radioBtn.props')" />
    </el-radio-group>
...
export default {
  ...
  data() {
    return {
      radioValue: this.$t('shardingsphere.ruleConfig').radioBtn.schema,
      currentView: MSchema
    }
  },
  methods: {
    onChange(val) {
      const radioBtn = this.$t('shardingsphere.ruleConfig').radioBtn
