...
<template>
  <el-row class="box-card">
    <el-radio-group v-model="radioValue" @change="onChange">
      <el-radio-button label="1">{{ $t('shardingsphere.runtimeStatus.serviceNode') }}</el-radio-button>
      <el-radio-button label="2">{{ $t('shardingsphere.runtimeStatus.slaveDataSourceName') }}</el-radio-button>
    </el-radio-group>
