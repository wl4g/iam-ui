    ...
    <el-dialog
      ...
      <el-form label-width="110px">
        <el-form-item label="Service Name:">
          <el-input v-model="serviceForm.serviceName" :placeholder="$t('shardingsphere.dataScaling.serviceDialog.serviceName')"/>
        </el-form-item>
        <el-form-item label="Service Url:">
          <el-input v-model="serviceForm.serviceUrl" :placeholder="$t('shardingsphere.dataScaling.serviceDialog.serviceUrl')"/>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    ...
    getJobServer() {
      ...
      this.$$api_shardingsphere4_getJobServer({
        data: {},
        fn: json => {
          const res = json.data;
          const { model } = res
    ...
    getSchemaDataSource(schemaName) {
      this.$$api_shardingsphere4_getSchemaDataSource({
    ...
    getSchemaRule(schemaName) {
      this.$$api_shardingsphere4_getSchemaRule({
        data: {schemaName: schemaName},
        fn: json => {
          const res = json.data;
          const { model } = res
    ...
    getSchema() {
      this.$$api_shardingsphere4_getSchema({
        data: {},
        fn: json => {
          const res = json.data;
    ...
    getJobList() {
      this.$$api_shardingsphere4_getJobList({
        data: {},
        fn: json => {
          const res = json.data;
    ...
    handlerStop(row) {
      ...
      this.$$api_shardingsphere4_postJobStop({
        data: params,
        fn: json => {
          const res = json.data;
          this.$notify({
    ...
    getJobProgress(row) {
      ...
      this.$$api_shardingsphere4_getJobProgress({
        data: {jobId: jobId},
        fn: json => {
          const res = json.data;
          const { model } = res
    ...
    onConfirm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.$$api_shardingsphere4_getJobStart({
            data: params,
            fn: json => {
              const res = json.data;
