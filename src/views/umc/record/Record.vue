                ...
                <!--<el-row>
                    <el-col :span="12">
                        <el-form-item label="Metric:" >
                            <el-input v-model="saveForm.metric" readonly ></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>-->
                        ...
                        <el-table :data="saveForm.alarmRules" style="width: 100%">
                            ...
                            <el-table-column  label="LogicalOperator" >
                                <template scope="scope">
                                    <el-select v-model="scope.row.logicalOperator" disabled>
                            ...
                            <el-table-column  label="Aggregator">
                                <template scope="scope">
                                    <el-select v-model="scope.row.aggregator"  disabled>
                            ...
                            <el-table-column  label="RelateOperator">
                                <template scope="scope">
                                    <el-select v-model="scope.row.relateOperator" disabled>
                            ...
                            <el-table-column  label="AlarmLevel">
                                <template scope="scope">
                                    <el-select v-model="scope.row.alarmLevel" placeholder="AlarmLevel" disabled>
