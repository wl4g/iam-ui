                        ...
                        <el-table :data="contactData" style="width: 100%">
                            ...
                            <el-table-column label="Operation" min-width="100">
                                <template slot-scope="scope">
                                    <el-button type="info" icon='edit' size="small" @click="editContact(scope.row)">Edit</el-button>
                                    <el-button type="danger" icon='delete' size="small" @click="delContact(scope.row)">Del</el-button>
                                </template>
                            </el-table-column>
