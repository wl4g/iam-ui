    ...
    <section id="configuration" class="configuration">
        ...
        <el-dialog :close-on-click-modal="false" :title="dialogTitle" :visible.sync="dialogVisible"  v-loading='dialogLoading'>
            <el-form label-width="80px" size="mini" :model="saveForm" ref="saveForm" class="demo-form-inline" :rules="rules">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="第二master地址" prop="secondaryMasterAddr">
                            <el-input v-model="saveForm.secondaryMasterAddr"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                    ...
                    <el-col :span="24">
                        <el-form-item label="Host" prop="hostIds">
                            <el-transfer
                                ...
                                <router-link slot="left-footer" to="/erm/host" target="_blank" class="link" style="margin-left: 10px">前往配置</router-link>
                            </el-transfer>
                        </el-form-item>
                    </el-col>
                </el-row>
...
<script>
    import K8sCluster from './K8sCluster.js'
