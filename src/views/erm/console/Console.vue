<template>
  <section class="console">
    <!-- //表单 -->
    <el-form :inline="true" :model="formInline" class="clearfix searchbar">
      ...
      <el-form-item style='float:right'>
          <el-button type="danger" @click="cleanConsole()" icon='delete2'>Clean</el-button>
      </el-form-item>
      <el-form-item style='float:right'>
        <!-- 新增按钮 -->
            ...
            <div style="float:left;">
              <template>
                <el-table
                  ...
                  style="width: 100%">
                  <!-- 动态标签 -->
                  <el-table-column :label="$t('message.srm.include')" min-width="90">
                  ...
                  <el-table-column  :label="$t('message.common.operation')" width="110">
