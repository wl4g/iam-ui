    ...
    <div class="table-wrap">
      <el-form
        ...
        <el-form-item>
          ...
          <el-col :span="8">
            <el-checkbox
              ...
              :disabled="viewMode">{{ $t('elasticjob.jobConfig.labelInfo.failover') }}</el-checkbox>
          </el-col>
          <el-col :span="4">
          ...
          <el-col :span="8">
            <el-checkbox
              ...
              :disabled="viewMode">{{ $t('elasticjob.jobConfig.labelInfo.misfire') }}</el-checkbox>
          </el-col>
        </el-form-item>
        ...
        <el-form-item>
          ...
          <el-col :span="4">
            {{ $t('elasticjob.jobConfig.labelInfo.streamingProcess') }}
          </el-col>
          <el-col :span="8">
            <el-checkbox
        ...
        <el-form-item>
          <el-col :span="4">
            {{ $t('elasticjob.jobConfig.labelInfo.scriptCommandLine') }}
          </el-col>
          <el-col :span="7">
            <el-input
