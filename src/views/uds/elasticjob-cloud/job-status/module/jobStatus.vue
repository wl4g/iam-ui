...
<template>
  <el-tabs
    ...
    <el-tab-pane
      :label="$t('elasticjob.jobStatus.tab.running')"
      name="running">
      <div
    ...
    <el-tab-pane
      :lazy="lazyInit"
      :label="$t('elasticjob.jobStatus.tab.ready')"
      name="ready">
    ...
    <el-tab-pane
      :lazy="lazyInit"
      :label="$t('elasticjob.jobStatus.tab.failover')"
      name="failover">
      <div class="btn-group pull-right" style="float: right;">
        <el-input
...
export default {
  ...
  data() {
    return {
      ...
      columnRunning: [
        {
          label: this.$t('elasticjob.jobStatus').labelInfo.id,
          prop: 'id'
        },
        {
          label: this.$t('elasticjob.jobStatus').labelInfo.taskName,
          prop: 'jobName'
        },
        {
          label: this.$t('elasticjob.jobStatus').labelInfo.severIp,
          prop: 'slaveId'
        },
        {
          label: this.$t('elasticjob.jobStatus').labelInfo.type,
          prop: 'type'
        },
        {
          label: this.$t('elasticjob.jobStatus').labelInfo.shardingItems,
          prop: 'shardingItemsTitle'
        }
      ],
      columnReady: [
        {
          label: this.$t('elasticjob.jobStatus').labelInfo.jobName,
          prop: 'jobName'
        },
        {
          label: this.$t('elasticjob.jobStatus').labelInfo.times,
          prop: 'times'
        }
      ],
      columnFailover: [
        ...
        {
          label: this.$t('elasticjob.jobStatus').labelInfo.originalTaskId,
          prop: 'originalTaskId'
        },
        {
          label: this.$t('elasticjob.jobStatus').labelInfo.shardingItems,
