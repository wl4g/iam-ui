  ...
  <el-row class="box-card">
    <el-form :model="searchForm" class="demo-form-inline">
      <el-form-item>
        ...
        <el-col :span="14">
          <el-link type="info" disabled> {{ $t('elasticjob.operationJobs.labelInfo.jobName') }}:</el-link>
...
export default {
  ...
  data() {
    return {
      ...
      column: [
        {
          label: this.$t('elasticjob.operationJobs').labelInfo.item,
          prop: 'item'
        },
        {
          label: this.$t('elasticjob.operationJobs').labelInfo.serverIp,
          prop: 'serverIp'
        },
        {
          label: this.$t('elasticjob.operationJobs').labelInfo.instanceId,
          prop: 'instanceId'
        },
        {
        ...
        {
          label: this.$t('elasticjob.operationJobs').labelInfo.failover,
          prop: 'failover'
        }
      ],
      statusColor: {
  ...
  methods: {
    ...
    getShardingInfo() {
      ...
      this.$$api_elasticjob_getShardingInfo({
        data: params,
        fn: json => {
          let res = json.data
    ...
    handleEnable(row) {
      ...
      this.$$api_elasticjob_enableSharding({
        data: params,
        fn: json => {
          let res = json.data
          this.$notify({
    ...
    handleDisable(row) {
      ...
      this.$$api_elasticjob_disableSharding({
        data: params,
        fn: json => {
          let res = json.data
          this.$notify({
