  ...
  <el-row class="box-card">
    <el-form :model="searchForm" class="demo-form-inline">
      <el-form-item>
        ...
        <el-col :span="14">
          <el-link type="info" disabled> {{ $t('elasticjob.operationServers.labelInfo.serverIp') }}:</el-link>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button
              ...
              size="mini"
              plain>
              {{ $t("elasticjob.operationServers.statusText.OK") }}
            </el-button>
            <el-button
              ...
              size="mini"
              plain>
              {{ $t("elasticjob.operationServers.statusText.DISABLED") }}
            </el-button>
            <el-button
              ...
              size="mini"
              plain>
              {{ $t("elasticjob.operationServers.statusText.SHARDING_FLAG") }}
            </el-button>
            <el-button
              ...
              size="mini"
              plain>
              {{ $t("elasticjob.operationServers.statusText.PENDING") }}
            </el-button>
            <el-button
              ...
              size="mini"
              plain>
              {{ $t("elasticjob.operationServers.statusText.CRASHED") }}
            </el-button>
          </template>
        </el-table-column>
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button-group>
              ...
              <el-button
                ...
                type="danger"
                plain
                @click="handleRemove(scope.row)">{{ $t("elasticjob.operationServers.actionText.remove") }}</el-button>
            </el-button-group>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  data() {
    return {
      ...
      serverIp: '',
      columnJobName: {
        label: this.$t('elasticjob.operationServers').labelInfo.jobName,
        prop: 'jobName'
      },
      columnInstanceCount: {
        label: this.$t('elasticjob.operationServers').labelInfo.instanceCount,
        prop: 'instanceCount'
      },
      columnStatus: {
        label: this.$t('elasticjob.operationServers').labelInfo.status,
        prop: 'status'
      },
      statusColor: {
        OK: 'success',
  ...
  methods: {
    ...
    handleEnable(row) {
      ...
      this.$$api_elasticjob_enableServerJob({
        data: params,
        fn: json => {
          let res = json.data
          this.$notify({
    ...
    handleDisable(row) {
      ...
      this.$$api_elasticjob_disableServerJob({
        data: params,
        fn: json => {
          let res = json.data
          this.$notify({
    ...
    handleShutdown(row) {
      ...
      this.$$api_elasticjob_shutdownServerJob({
        data: params,
        fn: json => {
          let res = json.data
          this.$notify({
    ...
    handleRemove(row) {
      ...
      this.$$api_elasticjob_removeServerJob({
        data: params,
        fn: json => {
          let res = json.data
          this.$notify({
