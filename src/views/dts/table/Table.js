...
export default {
    ...
    methods: {
        ...
        addData() {
            this.$router.push({ path: this.permitutil.getRoutePathByPermission('dts:table:edit'), query: { projectId: this.projectId } })
        },

        openTableEdit(row) {
            this.$router.push({ path: this.permitutil.getRoutePathByPermission('dts:table:edit'), query: { id: row.id, projectId: this.projectId } })
        },
