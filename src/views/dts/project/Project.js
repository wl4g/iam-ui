...
export default {
    ...
    methods: {
        ...
        addData() {
            this.$router.push({ path: '/dts/codegen/project/edit' })
        },
        // 获取列表数据
        getData() {
            this.loading = true;
        ...
        editData(row) {
            ...
            this.$router.push({ path: '/dts/codegen/project/edit', query: { id: row.id } })
        },
        delData(row) {
            if (!row.id) {
                return;
        ...
        toTable(row) {
            this.$router.push({ path: '/dts/codegen/project/table', query: { id: row.id } })
        },
