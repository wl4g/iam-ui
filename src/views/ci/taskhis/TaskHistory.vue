<template>
    <section id="configuration" class="configuration">
        ...
        <div>
            <template>
                <el-table :data="tableData" border @row-dblclick="doubleClickRow" style="width:100%">
                    ...
                    <el-table-column prop="updateDate" :label="$t('message.common.updateDate')"></el-table-column>
